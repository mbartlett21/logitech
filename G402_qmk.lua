...
local clickmaps = {
    ...
    { ______, ______, ______, KB_PST, KB_CPY, MO(2),  TO(3),  GU_LFT },
    { ______, ______, ______, ______, KB_CUT, ______, GU_MID, GU_RGT },
    { ______, ______, ______, GU_MID, GU_LFT, MO(4),  TO(1),  GU_RGT },
    { ______, ______, ______, ______, ______, ______, GU_MID, GU_LFT },
}
